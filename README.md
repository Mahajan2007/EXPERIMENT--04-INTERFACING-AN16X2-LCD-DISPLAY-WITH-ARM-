...
int main(void)
{
  ...
  Lcd_cursor(&lcd, 0,1);
  Lcd_string(&lcd,"Mahajanani.R");
  Lcd_cursor(&lcd, 1,1);
  Lcd_string(&lcd, "212224230147");
...
## Output screen shots of proteus  :
 ![exp4op](https://github.com/user-attachments/assets/895e2f1f-6002-468e-92a8-7e9286bee9ea)

 
 ## CIRCUIT DIAGRAM (EXPORT THE GRAPHICS TO PDF AND ADD THE SCREEN SHOT HERE): 
 
 ![exp4op1](https://github.com/user-attachments/assets/b92496ef-56d9-4485-ad5e-7569d0508beb)
